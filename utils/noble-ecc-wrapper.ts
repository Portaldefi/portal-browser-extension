...
function normalizeScalar(scalar: unknown) {
  let num;
...
function pointAddScalar(p: string | Uint8Array, tweak: unknown, isCompressed: boolean | undefined) {
...
function pointMultiply(p: string | Uint8Array, tweak: Uint8Array, isCompressed: boolean | undefined) {
  const P = necc.Point.fromHex(p);
...
function privateAdd(privateKey: number | bigint | (string | Uint8Array), tweak: unknown) {
...
function privateNegate(privateKey: number | bigint | (string | Uint8Array)) {
  const p = normalizePrivateKey(privateKey);
...
const ecc = {
  ...
  privateNegate: (d: Uint8Array): Uint8Array | null => privateNegate(d),
